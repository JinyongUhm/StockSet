...
Public Class uc0_ListViewSortable
    ...
    Private Sub uc0_ListViewSortable_ColumnClick(ByVal sender As Object, ByVal e As System.Windows.Forms.ColumnClickEventArgs) Handles Me.ColumnClick
        ...
        If Me.Columns(e.Column).Tag IsNot Nothing Then
            Dim sort_type As String = Me.Columns(e.Column).Tag.ToString
            Select Case sort_type
                Case "i"
                    ListViewItemSorter = New ListViewItemComparer(e.Column, Me.Sorting, ListViewSortType.LV_SORT_INT)
                Case "f"
                    ListViewItemSorter = New ListViewItemComparer(e.Column, Me.Sorting, ListViewSortType.LV_SORT_FLOAT)
                Case Else
                    ListViewItemSorter = New ListViewItemComparer(e.Column, Me.Sorting, ListViewSortType.LV_SORT_STRING)
            End Select
        End If
        ...
        Public Function Compare(ByVal x As Object, ByVal y As Object) As Integer Implements System.Collections.IComparer.Compare
            ...
            Select Case _SortType
                ...
                Case ListViewSortType.LV_SORT_INT
                    'integer sorting
                    Dim x_int As Long = Convert.ToInt64(x_item.SubItems(_ColumnNumber).Text)
                    Dim y_int As Long = Convert.ToInt64(y_item.SubItems(_ColumnNumber).Text)
                ...
                Case ListViewSortType.LV_SORT_FLOAT
                    'float sort
                    Dim x_float As Double = Convert.ToDouble(x_item.SubItems(_ColumnNumber).Text)
                    Dim y_float As Double = Convert.ToDouble(y_item.SubItems(_ColumnNumber).Text)
